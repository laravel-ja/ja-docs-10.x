...
> ２月１６日現在、翻訳を開始しました。全ページ翻訳完了まで、翻訳抜け、誤訳、エッラタなどの報告はご遠慮ください。翻訳完了後にお願いします。（翻訳完了時にこの文章を削除します。）
...
皆さん自身の技術者としての知識とコンプライアンス精神を表すために、他のMITライセンスのプロジェクトからドキュメントなど一部を記事などから参照し、公開する場合もきちんと参照元を示しましょう。忘れがちですが動画、ポッドキャスト中でも同様です。
